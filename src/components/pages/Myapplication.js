...
function Myapplication({ number, setNumber }) {
    ...
    function Logout() {
        ...
        return (
            <>
                ...
                <div style={{ width: "80%" }}>
                    <div style={{ position: 'absolute', top: "12vh", left: "38vw", width: "48.7%" }}>
                        {/* <div class='mb-4'>
 ...
 text-decoration-none">Team id</h6>
                        ...
                        <div class="mb-3">
                            <h5> <label for="formFile" style={{ marginTop: "3rem", marginBottom: "1.5rem" }} class="form-label fw-semibold float-start">Submit your project file </label></h5>
