  ...
  return (
    ...
    <div className="row flex-nowrap bg-dark">
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0">
            <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <li>
                        ...
                        <ul className="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li className="w-100">
                                <a href="#overview" className="nav-link px-0"> <span className="d-none d-sm-inline text-white" justifyContent='center' alignItems= 'center'>Hackathan</span></a>
                            </li>
                            <li>
            ...
            <div id="Hackathan" className="inner-panel text-dark" >
...
<h2 className="regular dark weight-600 caps inline-block float-left fs-5  " id='overview'  style={{textAlign : 'justify'}}>
 ...
 <h3>This is the most exciting event everyone is waiting for, the Incedo own Hackathon - Incedo Hack-lite</h3> 
 </div>
...
<p style={{textAlign : 'justify'}}>The theme of this year hackathon is - <strong>, Building Intelligent Products In Your Respective Domain </strong>— that will helps our clients as well as the organisation itself for better future.&nbsp;</p>
</div>
{/* <div id="prize" className="inner-panel" >
    ...
    <h2 className="regular dark weight-600 caps inline-block float-left fs-5"  style={{textAlign : 'justify', padding:"30px 0px 0px 0px"}}>
     ...
     <h5 style={{ color: 'grey' }}>First Prize</h5> 
     </div>
    <h5  style={{textAlign : 'justify'}}><b>Grand Prize :</b> <h6 style={{ color: 'grey' }}>USD 10000</h6></h5>
    <Typography component="div">
      <ul style={{textAlign : 'justify'}}>
        <li>The First prize, reserved for the winner team of the Incedo Hacklite: Global Hackathon.</li>
