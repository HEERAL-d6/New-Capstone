...
function Carousel() {
  return (
    <div className="text-center bg-dark text-white">
      ...
      <div className='head my-3 bg-dark text-white' style={{ textAlign: 'left', fontSize: '24px', marginLeft: '4rem', marginTop:"3rem" }}>
        <p style={{ fontWeight: 'bold' }}>INCEDO</p>
      </div>
      <div className="Table my-2 bg-dark text-white" style={{ height: "50vh" }}>
